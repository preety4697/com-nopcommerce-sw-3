...
public class TestSuite extends Utility {
    ...
    public void verifyProductAddedToShoppingCartSuccessFully() throws InterruptedException {
        ...
        //Add first name
        sendTextToElement(By.id("BillingNewAddress_FirstName"), "Hello");

        //Add Last name
        sendTextToElement(By.id("BillingNewAddress_LastName"), "Tester");

        //Add email address
        sendTextToElement(By.id("BillingNewAddress_Email"), "hellotester1@gmail.com");
        ...
        //Add address1
        sendTextToElement(By.id("BillingNewAddress_Address1"), "Sudbury");
        ...
        sendTextToElement(By.id("CardholderName"), "Hello");
